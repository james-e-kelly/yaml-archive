...
namespace std {
template <>
inline string& string::replace(char* first1, char* last1, const char* first2,
                               const char* last2)
{
...
/////////1/////////2/////////3/////////4/////////5/////////6/////////7/////////8
// specific definitions for char based YAML

template <> void yaml_grammar::init_chset()
{
...
#include "basic_yaml_grammar.inl"

namespace boost {
namespace archive {

// explicit instantiation of yaml for 8 bit characters
template class basic_yaml_grammar<char>;
